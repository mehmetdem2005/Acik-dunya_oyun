...
BLEND = os.path.join(Lib.OUT_DIR, "mouse_v17.blend")
OUT = os.path.join(Lib.OUT_DIR, "qa_overlay17"); os.makedirs(OUT, exist_ok=True)
...
# bones-only
sc.display.shading.show_xray=True; sc.display.shading.xray_alpha=0.30
