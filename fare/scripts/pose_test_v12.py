"""
Stage 3 v12 pose test — verify rig CONSTRAINTS actually work:
...
Usage:
    blender --background --python fare/scripts/pose_test_v12.py
"""
...
OUT_DIR = os.path.join(ROOT, "out", "pose_test_v12")
