"""
Stage 3 v11 pose test — verify rig CONSTRAINTS actually work:
...
Usage:
    blender --background --python fare/scripts/pose_test_v11.py
"""
...
OUT_DIR = os.path.join(ROOT, "out", "pose_test_v11")
os.makedirs(OUT_DIR, exist_ok=True)
sys.path.insert(0, os.path.join(ROOT, "scripts"))
import rig_mouse_v11 as v11
...
def build():
    v11.reset_scene()
    v11.import_glb(v11.SRC)
    tripo = v11.extract_tripo_skeleton()
    mesh = v11.cleanup_keep_mesh_only()
    arm, meta = v11.build_rig(tripo, mesh)
    v11.setup_pose_rigging(arm, meta, tripo, mesh)
