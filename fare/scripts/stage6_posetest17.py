...
Loads mouse_v17.blend, applies ONE bone pose at a time, renders, and measures
...
BLEND = os.path.join(L.OUT_DIR, "mouse_v17.blend")
OUT = os.path.join(L.OUT_DIR, "qa_posetest17")
...
def main():
    ...
    tests = [
        ...
        ("jaw",  ("X", 25),  {"head"},      "jaw_open"),
        ("tail_04",   ("Z", 40),  {"tail"},      "tail_curl"),
