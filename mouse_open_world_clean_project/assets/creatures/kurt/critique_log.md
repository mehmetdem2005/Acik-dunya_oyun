...
## Round 105 — 2026-06-01
**Önceki (round 104) en büyük 3 kusur:**
1. Stop kırılması yumuşak (snout→alın geçişi subsurf'te fazla yumuşamış, kurt stop kontrastı zayıf).
2. Yüz mikro-detay — kalıcı.
3. Genel rötuş.
**Uygulanan parametre değişiklikleri:**
...
**Önceki (round 106) en büyük 3 kusur:**
1. Boyun side biraz ince (referans kurt güçlü kaslı boyun, kafa-omuz dolu geçiş).
2. Topline (kabul edilebilir).
3. Yüz mikro-detay — kalıcı.
**Uygulanan parametre değişiklikleri:**
- neck (y-0.120) hw 0.202→0.208, neck_front (y-0.085) hw 0.214→0.220 (boyun side kaslı, kafa-omuz dolu geçiş) — kusur 1.
**Sonuç render notu:** round_107_three_q/side/top.png — boyun side kalınlaştı, kaslı güçlü kurt boynu, kafa-omuz dolu geçiş; mesh sağlam 29472 tri.
**Sonraki tura öncelik:** Arka bacak metatarsus side açı; topline withers; genel rötuş; kafa orantı.

## Round 108 — 2026-06-01
**Önceki (round 107) en büyük 3 kusur:**
1. Kuyruk ucu biraz kalın bitiyor (referans kuyruk gür gövde + sivrilen uç).
2. Arka metatarsus açı (kabul edilebilir).
3. Yüz mikro-detay — kalıcı.
**Uygulanan parametre değişiklikleri:**
- tail tip_r 0.048→0.042 (uç sivri), bush 1.48→1.52 (orta gür korundu) — kusur 1.
**Sonuç render notu:** round_108_three_q/rear_q/side.png — kuyruk gür gövde + doğal sivrilen uç, referans kurt kuyruk silüeti; mesh sağlam 29472 tri.
**Sonraki tura öncelik:** Genel rötuş; kafa orantı (gövdeye göre); topline; ön bacak side dirsek.

## Round 109 — 2026-06-01
**Önceki (round 108) en büyük 3 kusur:**
1. Kaş kemeri (göz üstü brow ridge) subtle (referans kurt belirgin göz üstü çıkıntı).
2. Kafa orantı (kabul edilebilir).
3. Yüz mikro-detay göz/burun — kalıcı.
**Uygulanan değişiklikler (kod):**
- _brow_ridge bump 0.026→0.034 (göz üstü kaş kemeri belirgin, kurt karakteri). Lokal, kafa bölgesi.
...
## Round 111 — 2026-06-01
**Önceki (round 110) en büyük 3 kusur:**
1. Top'ta omuz (en geniş) → bel (ince) kontrastı sert (sırt ortası geçişi ani).
2. Arka duruş (kabul edilebilir, dengeli).
3. Yüz mikro-detay — kalıcı.
**Uygulanan parametre değişiklikleri:**
- back_mid (y0.355) hw 0.180→0.172 (sırt ortası incelme, omuz→bel kademeli geçiş) — kusur 1.
**Sonuç render notu:** round_111_top/side/three_q.png — omuz-bel geçişi top'tan akıcı, kontrast yumuşadı, atletik gövde hattı; side topline+tuck korundu; mesh sağlam 29472 tri.
**Sonraki tura öncelik:** Genel rötuş; kalça-rump side; ön bacak side; kafa orantı son.

## Round 112 — 2026-06-01
**Önceki (round 111) en büyük 3 kusur:**
1. Sağrı/rump yan kası side biraz zayıf (referans kurt güçlü sağrı, kuyruk dibi kütleli).
2. Genel rötuş.
3. Yüz mikro-detay — kalıcı.
**Uygulanan parametre değişiklikleri:**
- rump (y0.775) hw 0.190→0.196 (sağrı yan kası dolgun, kuyruk dibi kaynaşma kütleli) — kusur 1.
**Sonuç render notu:** round_112_rear_q/side/top.png — sağrı dolgun güçlü arka çeyrek, kuyruk dibi-sağrı kütleli kaynaşma; croup eğimi korundu; mesh sağlam 29472 tri.
**Sonraki tura öncelik:** Genel rötuş; ön bacak side; kafa orantı; bel flank.

## Round 113 — 2026-06-01
**Önceki (round 112) en büyük 3 kusur:**
1. Kafatası üstü front'ta hafif dome/yuvarlak (referans kurt kafatası daha düz).
2. Genel rötuş.
3. Yüz mikro-detay — kalıcı.
**Uygulanan parametre değişiklikleri:**
